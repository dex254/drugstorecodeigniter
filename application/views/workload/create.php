...
<div class="page-content-wrap">
  <div class="row">
    <div class="col-md-12">
      <?php echo form_open_multipart('workload/store',$attributes); ?>
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title"><strong>Workload Dispensing</strong> Registration Form</h3>
              ...
              <div class="col-md-9">
                <div class="form-group">
                  <label class="col-md-3 control-label">Facility</label>
                    ...
                    <div class="form-group">
                      <label class="col-md-3 control-label">Requisition Officer</label>
                      <div class="col-md-9">
                        <div class="input-group">
                          <span class="input-group-addon"><span class="fa fa-user"></span></span>
                          <input type="text" id="requisition" name="requisition" required="required" value="<?php echo set_value('requisition');?>" class="form-control col-md-12 col-xs-12">
                        </div>
                        <span class="help-block"><?php echo form_error('requisition'); ?></span>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-md-9">
                        <div class="input-group">
                          <span class="input-group-addon"><span class="fa fa-user"></span></span>
                          <input type="text" id="designation" name="designation" required="required" value="<?php echo set_value('designation');?>" class="form-control col-md-12 col-xs-12">
                        </div>
