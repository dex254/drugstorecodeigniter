  ...
  <div class="panel-body">
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        <input type="hidden" name="<?php echo 'receivedId'.$i?>" value="<?php echo $cart['receivedId'];?>">
        <input type="hidden" name="<?php echo 'dwlid'.$i?>" value="<?php echo $cart['id'];?>">
