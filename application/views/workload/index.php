...
<div class="page-title">
  <h2><span class="fa fa-medkit"></span>Available Items</h2>
</div>
<!-- END PAGE TITLE -->
<!-- START STRIPED TABLE SAMPLE -->
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">List of Available Items<a href="<?php echo base_url('index.php/drug/createdrugPdf/');?>"><i class="fa fa-print"></i></a></h3>
    ...
    <table class="table table-striped table-hover">
      <thead>
        <tr>
          ...
          <th>Category</th>
          <th>Unit of Issue</th>
          <th>Stock (single unit i.e tablet)</th>
          <th>Action</th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="<?php echo base_url('index.php/workload/addToCart/'.$drug['id']);?>"><button type="button" class="btn btn-success btn-xs"><i class="fa fa-shopping-cart"></i>Add to Cart</button></a>
          </td>
        </tr>
        <?php endforeach ?>
      </tbody>
